defmodule AwscardsWeb.CardLiveTest do
  use AwscardsWeb.ConnCase

  import Phoenix.LiveViewTest
  import Awscards.DeckFixtures

  @create_attrs %{back: "some back", category: "some category", front: "some front", id: 42}
